...
import com.kct.tplusmcscenter.utils.camera.MainExecutor
...
var View.topPadding: Int
    get() = paddingTop
    set(value) = updateLayoutParams { setPaddingRelative(paddingStart, value, paddingEnd, paddingBottom) }
...
var View.startPadding: Int
    get() = paddingStart
    set(value) = updateLayoutParams { setPaddingRelative(value, paddingTop, paddingEnd, paddingBottom) }
//endregion
...
fun ViewGroup.circularReveal(button: ImageButton) = ViewAnimationUtils.createCircularReveal(
    this,
...
fun WebView.loadEntryUrl(key: String, appToken: String, firebaseToken: String, userId: String, appversion:String)
= this.loadUrl(
    BaseWebUrl.BASE_WEB_URL
        + BaseWebUrl.ENTRY_URL
        + "/?KEYVALUE=$key"
        + "&APPTOKEN=$appToken"
...
fun WebView.loadBlankUrl() = this.loadUrl("about:blank")